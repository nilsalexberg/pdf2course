...
<template>
  <div :class="!isLast ? 'border-b border-slate-800/40' : ''">
    ...
    >
      <div class="flex items-center gap-3">
        ...
        <span
          ...
          :class="{
            ...
            'bg-amber-900/40 border-amber-700/60 text-amber-400':
              !props.isCompleted && isInProgress,
        ...
        <div class="flex-1 min-w-0">
          <p
            class="text-sm font-medium text-slate-100 group-hover:text-white transition-colors truncate"
          >
            {{ lesson.title }}
          </p>
    ...
    <div v-if="isExpanded" class="px-6 pb-5 space-y-4 border-t border-slate-800/30 bg-slate-900/30">
