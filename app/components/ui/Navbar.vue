    ...
    <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
      ...
      <div class="flex items-center gap-6">
        <NuxtLink to="/" class="flex items-center gap-2 group">
          <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-emerald-500 text-slate-950 transition-transform group-hover:scale-110">
          ...
          <span class="text-lg font-bold tracking-tight text-white hidden sm:block">pdf2course</span>
        </NuxtLink>

        <div v-if="breadcrumbs.length > 0" class="hidden md:flex items-center gap-2 text-sm text-slate-500">
