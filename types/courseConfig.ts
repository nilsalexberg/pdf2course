export const COURSE_languageLevelS = [
  'Standard',
  'Technical',
  'Academic',
  'Simplified',
...
export const COURSE_FOCUS_OPTIONS = ['Balanced', 'Theoretical', 'Practical'] as const;

export const COURSE_LANGUAGES = ['English', 'Portuguese', 'Spanish'] as const;

export const COURSE_TONES = ['Standard', 'Formal', 'Casual', 'Inspiring'] as const;

export type CourseLanguageLevel = (typeof COURSE_languageLevelS)[number];
